...
export const CertificateTemplate: React.FC<CertificateTemplateProps> = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      {/* Header with Logo */}
      <div className={`absolute ${isLandscape ? 'top-4' : 'top-9'} left-4 flex items-center`}>
        <div>
          <img
            src={title}
            alt="India Drone Academy"
            className={`${isLandscape ? 'h-14' : 'h-16'}`}
          />
        </div>
      </div>

      {/* Certificate Title */}
      <div className={`absolute ${isLandscape ? 'top-[140px]' : 'top-[220px]'} left-0 right-0 text-center z-20`}>
      ...
      {/* Course Description */}
      <div className={`absolute ${isLandscape ? 'top-[280px]' : 'top-[400px]'} left-0 right-0 text-center`}>
      ...
      {/* Name Banner */}
      <div className={`absolute ${isLandscape ? 'top-[200px]' : 'top-[280px]'} left-0 right-0 flex justify-center z-10`}>
        <div className={`relative w-full ${isLandscape ? 'px-4' : 'px-8'}`}>
          <img
            ...
            className={`${
              isLandscape 
                ? 'h-[1200px] min-w-[800px] transform scale-[0.45]' 
                : 'h-[1200px] min-w-[500px] transform scale-[0.55]'
      ...
      {/* Personal Details */}
      <div className={`absolute ${isLandscape ? 'top-[340px]' : 'top-[480px]'} left-[80px] right-[40px]`}>
      ...
      {/* Training Details */}
      <div className={`absolute ${isLandscape ? 'top-[420px]' : 'top-[560px]'} left-[80px] right-[40px]`}>
      ...
      {/* Training Hours */}
      <div className={`absolute ${isLandscape ? 'top-[500px]' : 'top-[680px]'} left-[80px] right-[40px]`}>
      ...
      <div className={`absolute ${isLandscape ? 'bottom-[100px]' : 'bottom-[180px]'} left-[80px] right-[80px] flex justify-between items-end`}>
        ...
        <div className="text-center">
          <img
            src={stamp}
            alt="Seal"
            className={`${isLandscape ? 'h-32' : 'h-40'} w-40 mx-auto mt-16`}
          />
        </div>
        <div className="text-center w-[200px]">
          <div className="border-b border-gray-400 pb-1 mb-1">
